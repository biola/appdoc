...
Appdoc uses {declarative_autorization}[https://github.com/stffn/declarative_authorization], so you will have to do some basic setup to get user roles and permissions working.
...
You may customize the styles which are located in 'public/stylesheets/jquery/smart_text_box/SmartTextBox.css'.
